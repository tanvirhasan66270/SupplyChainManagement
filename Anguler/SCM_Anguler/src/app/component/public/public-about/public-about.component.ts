...
export class PublicAboutComponent {
  coreValues = [
    ...
    { title: 'Innovation', desc: 'Smart route optimization, automated analytics, and secure digital documentation.', icon: 'bi-lightbulb', color: '#dc3545', iconBg: 'bg-danger-subtle' },
  ...
  milestones = [
    ...
    { year: '2023', title: 'System Automation', desc: 'Launched automated route management and reporting analytics.', color: '#ffc107' },
